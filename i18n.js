(() => {
  const tr = {
    "People do not understand or remember the brand.":"İnsanlar markayı anlamıyor veya hatırlamıyor.",
    "We clarify positioning, identity and rollout so the business becomes easier to recognise, understand and choose.":"Konumlandırma, kimlik ve yayılımı netleştirerek işletmeyi tanınması, anlaşılması ve seçilmesi daha kolay hale getiririz.",
    "The website or product makes people work too hard.":"Web sitesi veya ürün insanları gereğinden fazla uğraştırıyor.",
    "We redesign the journey so value is understood faster and conversion happens with less friction.":"Değerin daha hızlı anlaşılması ve dönüşümün daha az sürtünmeyle gerçekleşmesi için yolculuğu yeniden tasarlarız.",
    "The business needs ongoing creative capacity without more internal overhead.":"İşletmenin ek iç yük oluşturmadan sürekli yaratıcı kapasiteye ihtiyacı var.",
    "We provide senior creative direction and production capacity as one external operating layer.":"Senior yaratıcı yönlendirme ve üretim kapasitesini tek bir dış operasyon katmanı olarak sağlarız.",
    "When design is not enough,":"Tasarım yetmediğinde,",
    "we build the system.":"sistemi kurarız.",
    "BARTSS Labs turns recurring operating problems into tools, automation and products. These systems are proof of how we solve problems beyond the surface.":"BARTSS Labs tekrarlayan operasyon problemlerini araçlara, otomasyona ve ürünlere dönüştürür. Bu sistemler problemleri yüzeyin ötesinde nasıl çözdüğümüzün kanıtıdır.",
    "START WITH THE PROBLEM":"PROBLEMİ SEÇ",
    "What are you":"Neyi",
    "trying to change?":"değiştirmek istiyorsunuz?",
    "Do not choose a service yet. Choose what is holding the business back. We assemble the right mix of brand, digital, motion and systems around that outcome.":"Henüz bir hizmet seçmeyin. İşletmeyi neyin geride tuttuğunu seçin. Marka, dijital, motion ve sistemleri o sonucun etrafında birleştiririz.",
    ...
    "Tell us what is not working →":"Neyin çalışmadığını anlatın →",
    ...
    "Start a":"Proje",
    "project":"başlat",
    "Something in your business is not working.":"İşletmenizde bir şey doğru çalışmıyor.",
    "We design what changes it.":"Onu değiştirecek sistemi tasarlıyoruz.",
    "Weak brand, confusing digital experience, low attention or repetitive production - start with the business problem. BARTSS builds the strategy, identity, experience, motion and systems needed to change it.":"Zayıf marka, kafa karıştıran dijital deneyim, düşük dikkat veya tekrarlayan üretim - iş problemiyle başlayın. BARTSS bunu değiştirmek için gereken strateji, kimlik, deneyim, motion ve sistemleri kurar.",
    "Show us what is not working":"Neyin çalışmadığını gösterin",
    "BRAND TRANSFORMATION":"MARKA DÖNÜŞÜMÜ",
    ...
    "Tell us the problem and where we can reply. Everything else is optional.":"Problemi ve size nereden ulaşabileceğimizi anlatın. Geri kalan her şey opsiyonel.",
    "More project context":"Daha fazla proje bağlamı",
    "We will use this to understand the problem before discussing scope.":"Kapsamı konuşmadan önce problemi anlamak için bu bilgiyi kullanacağız.",
    "Send the problem":"Problemi gönder",
